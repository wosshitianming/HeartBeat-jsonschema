-- Compatibility entry: Quartz JDBC JobStore. Source: db/mysql/07-quartz.sql.

SET NAMES utf8mb4;

-- ============================================================
-- Quartz JDBC JobStore（MySQL 8.0，表前缀 QRTZ_）
-- 幂等安装版本：不会删除已有 Quartz 数据。
-- ============================================================
